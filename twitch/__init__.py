##The following code is taken from the kodi TwitchTV plugin. See: https://github.com/StateOfTheArt89/Twitch.tv-on-XBMC
##This modified version is licensed under AGPLv3
